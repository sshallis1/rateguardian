        ...
        <Container>
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-2">
              Private Wealth Mortgage — Available in All 50 States
            </h2>
            <p className="text-neutral-600">
              Sean is licensed nationwide. Click your state for local jumbo and luxury market details.
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 max-w-5xl mx-auto">
            {STATES.map((s) => (
              <Link
                key={s.slug}
                href={`/private-wealth-mortgage/${s.slug}`}
